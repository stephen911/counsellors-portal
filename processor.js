$(function () {
  ...
  $(".resett").submit(function (e) {
    e.preventDefault();
    // before();
    // var id = $(this).attr('id');
    var staff = {
      url: "processor.php?action=resett",
      type: "post",
      data: new FormData(this),
      cache: false,
      contentType: false,
  ...
  $(".updatepass").submit(function (e) {
    ...
    // var id = $(this).attr('id');
    var staff = {
      url: "processor.php?action=updatepass",
      type: "post",
      data: new FormData(this),
      cache: false,
      contentType: false,
  ...
  $(".ureset").submit(function (e) {
    e.preventDefault();
    // before();
    // var id = $(this).attr('id');
    var staff = {
      url: "processor.php?action=ureset",
      type: "post",
      data: new FormData(this),
      cache: false,
      contentType: false,
